...
const WEATHER_ALERTS = {
  ...
  thunder: {
    text: "Thunderstorms nearby. Stay clear of metal tools and cover seedlings.",
    icon: AlertTriangle,
  },
  clear_night: {
    ...
    <div className="space-y-5 py-2">
      <header className="flex animate-fade-in-up items-start justify-between gap-4">
        <div className="min-w-0 flex-1 overflow-hidden">
          ...
          <h1 className="font-heading text-4xl font-semibold leading-[1.05] tracking-tight break-words pr-1">
            {displayName}
          </h1>
        ...
        <div className="flex shrink-0 items-start gap-2">
          <button
            ...
            className="flex h-11 w-11 shrink-0 items-center justify-center border border-border bg-card/90 text-primary shadow-sm backdrop-blur hover:border-primary"
          >
